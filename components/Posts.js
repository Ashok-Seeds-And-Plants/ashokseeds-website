                        ...
                        return (
                            <div className="blog-card style3">
                                <div className="blog-img">
                                    ...
                                    <a href="{delve(post, "attributes.slug")}" className="blog-date"><span>25</span> Jul, 2022</a>
                                </div>
                                <div className="blog-info">
                                    <h3><a href="{delve(post, "attributes.slug")}">{title}</a></h3>
                                    ...
                                    <a href="{delve(post, "attributes.slug")}" className="link style1">Read More <i
